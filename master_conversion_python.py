...
procdir="/rds/project/bn204/rds-bn204-asterics/mdm49/IDR2_arrays_python"
...
# IDR2 DATASET
# days done: 2458098, 2458099, 2458101, 2458102, 2458103, 2458104, 2458105, 2458106, 2458107, 2458108, 2458109, 2458110, 2458111, 2458112, 2458113, 2458114, 2458115, 2458116, 2458140
...
# InTimes not necessarily same for each day - maybe set a range? need to check with alignement too
# InTimes=[66239]

InData=[]
# InData=['/rds/project/bn204/rds-bn204-asterics/HERA/data/2458109/xx/zen.2458109.14043.xx.HH.uv', '/rds/project/bn204/rds-bn204-asterics/HERA/data/2458109/xx/zen.2458109.36413.xx.HH.uv', '/rds/project/bn204/rds-bn204-asterics/HERA/data/2458109/xx/zen.2458109.38649.xx.HH.uv', '/rds/project/bn204/rds-bn204-asterics/HERA/data/2458113/xx/zen.2458113.50580.xx.HH.uv']
...
NUMBER_OF_CORES = 32 #len(IDRDays) # reduce number of cores
...
# fringe-rotation to galactic centre:
def fringerot(din):
...
def main():
    ...
    print(str(len(InData))+' uv datasets to reduce')
